...
from harness.TestCaseQasm import get_file_path, TestCaseQasm

PATH_BASE = os.path.join(os.path.dirname(__file__), "..", "examples")
CATEGORIES = next(os.walk(PATH_BASE))[1]


class TestRunner(TestCaseQasm):
    "Valid circuits"


    def test_valids(self): # pylint: disable=no-self-use
        ...
        for category in CATEGORIES:
            ...
            for filename in filenames:
                ...
                if ext == "qasm":
                    ...
                    self.assert_file(get_file_path(category, "missing_semicolon"))
